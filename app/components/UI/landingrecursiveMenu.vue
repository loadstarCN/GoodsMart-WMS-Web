        ...
        <li v-for="(firstLevelMenuItem, subIndex) in menuData.children" :key="subIndex"
            ...
            <template v-if="firstLevelMenuItem?.type === 'link'">
                <a href="#"
                    ...
                    class="side-menu__item" :class="`${firstLevelMenuItem?.selected ? 'active' : ''}`">
            ...
            <template v-if="firstLevelMenuItem?.type === 'sub'">
                <landingrecursiveMenu :menuData="firstLevelMenuItem" :handleLinkClick="handleLinkClick"
                    :setSubmenu="setSubmenu" :toggleSubmenu="toggleSubmenu" :level="level + 1" />
            </template>
        </li>
    </ul>
</template>
