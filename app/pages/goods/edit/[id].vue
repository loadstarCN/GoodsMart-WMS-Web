...
const saveProduct = async () => {
  ...
  await httpRequest(`/api/warehouse/goods/${itemId}`, {
    ...
    onError: (error) => {
      showToast(t('action-results.op-failed',{operation:t('goods.operations.edit'),entity:itemData.value.name}), 'error')
...
const fetchData = async () => {
    loading.value = true;
    const data = await httpRequest(`/api/warehouse/goods/${itemId}`, {
        method: 'GET',
        params: route.query,
        onSuccess: (data) => {
          itemData.value = data;
                  ...
                  <div class="card-body p-0">
                    <div class="row gy-3">
                      ...
                      <div class="col-xl-12">
                        ...
                        <input type="text" class="form-control" id="product-name" :placeholder="t('common.placeholders.name')"
                          v-model="itemData.name" required>
                        <label for="product-name" class="form-label mt-1 fs-12 op-5 text-muted mb-0">*{{ t('common.tips.name')}}</label>
                      ...
                      <div class="col-xl-6">
                        <label for="product-code" class="form-label">{{ t('goods.fields.code')}} <abbr title="required"
                            aria-hidden="true" class="text-danger">*</abbr></label>
                        <input type="text" class="form-control" id="product-code" :placeholder="t('goods.form.placeholders.code')"
                          v-model="itemData.code">
                        <label for="product-code" class="form-label mt-1 fs-12 op-5 text-muted mb-0">*{{ t('goods.form.tips.code')}}</label>
                      ...
                      <div class="col-xl-6">
                        ...
                        <input type="text" class="form-control" id="product-brand" :placeholder="t('goods.form.placeholders.brand')"
                      ...
                      <div class="col-xl-6 color-selection">
                        ...
                        <input type="text" class="form-control" id="product-manufacturer" :placeholder="t('goods.form.placeholders.manufacturer')"
                          v-model="itemData.manufacturer">
                      </div>
                      ...
                      <div class="col-xl-12">
                        ...
                        <VueMultiselect id="product-tags" :show-labels="false" v-model="itemData.tags"
                          :tag-placeholder="t('goods.form.placeholders.tag-add')" :placeholder="t('goods.form.placeholders.tags')" :options="selectOptions.tagOptions" :multiple="true" :taggable="true" @tag="addTag">
                        </VueMultiselect>
                      </div>
                    ...
                    <div class="row gy-4">
                      <div class="col-xl-4">
                        ...
                        <input v-maska:[] type="text" class="form-control number-format" id="product-price"
                          data-maska="0.99" data-maska-tokens="0:\d:multiple|9:\d:optional" :placeholder="t('goods.form.placeholders.price')"
                          v-model="itemData.price">
                      </div>
                      <div class="col-xl-4">
                        <label for="product-discount-price" class="form-label">{{ t('goods.fields.discount-price')}}</label>
                        <input v-maska:[] type="text" class="form-control number-format" id="product-discount-price"
                          data-maska="0.99" data-maska-tokens="0:\d:multiple|9:\d:optional" :placeholder="t('goods.form.placeholders.discount-price')"
                          v-model="itemData.discount_price">
                      </div>
                      <div class="col-xl-4">
                      ...
                      <div class="col-xl-4">
                        ...
                        <input v-maska:[] type="text" class="form-control number-format" id="product-length"
                          data-maska="0" data-maska-tokens="0:\d:multiple|9:\d:optional" :placeholder="t('goods.form.placeholders.length')"
                          v-model="itemData.length">
                        <label for="product-length" class="form-label mt-1 fs-12 op-5 text-muted mb-0">*{{ t('goods.form.tips.dimensions')}}</label>
                      </div>
                      <div class="col-xl-4">
                        ...
                        <input v-maska:[] type="text" class="form-control number-format" id="product-width"
                          data-maska="0" data-maska-tokens="0:\d:multiple|9:\d:optional" :placeholder="t('goods.form.placeholders.width')"
                          v-model="itemData.width">
                        <label for="product-width" class="form-label mt-1 fs-12 op-5 text-muted mb-0">*{{ t('goods.form.tips.dimensions')}}</label>
                      </div>
                      <div class="col-xl-4">
                        ...
                        <input v-maska:[] type="text" class="form-control number-format" id="product-height"
                          data-maska="0" data-maska-tokens="0:\d:multiple|9:\d:optional" :placeholder="t('goods.form.placeholders.height')"
                      ...
                      <div class="col-xl-6">
                        ...
                        <div class="form-group">
                          <div class="input-group flex-nowrap input-group-custom">
                            ...
                            <Datepicker id="production-date" :placeholder="t('goods.form.placeholders.product-date')" class="form-control" autoApply
                              :enable-time-picker="false" v-model="itemData.production_date" />
                          </div>
                        </div>
                      </div>
                      <div class="col-xl-6">
                        ...
                        <div class="form-group">
                          <div class="input-group flex-nowrap input-group-custom">
                            <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                            <Datepicker id="expiration-date" :placeholder="t('goods.form.placeholders.expiry-date')" class="form-control"
                              autoApply :enable-time-picker="false" v-model="itemData.expiration_date" />
                          </div>
                        </div>
                      </div>
