          ...
          <div class="card-header d-md-flex d-block">
              <div class="h5 mb-0 d-sm-flex d-bllock align-items-center">
                  ...
                  <div class="ms-sm-2 ms-0 mt-sm-0 mt-2">
                      <div class="h6 fw-semibold mb-0">#DN-<span class="text-color">{{itemData?.id}}</span>
                      </div>
                  </div>
              </div>
        ...
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_align_center tm_mb20">
            ...
            <div class="tm_invoice_right tm_text_right">
              <div class="tm_primary_color tm_f50 tm_text_uppercase">{{t('dn.entity')}}
              </div>
            </div>
          </div>
          <div class="tm_invoice_info tm_mb20">
            ...
            <div class="tm_invoice_info_list">
              <p class="tm_invoice_number tm_m0">{{t('dn.fields.number')}}： <b class="tm_primary_color">#DN-{{ itemData?.id }}</b></p>
              <p class="tm_invoice_date tm_m0">{{t('dn.fields.type')}}:  <b class="tm_primary_color">{{ t('dn.type.'+itemData?.dn_type) }}</b></p>
          ...
          <div class="tm_mb30">
            <div class="row g-3">
              <div class="col-3">
              <p class="tm_mb2"><b class="tm_primary_color">{{t('common.entities.recipient')}}</b></p>
              <p>{{itemData?.recipient?.name}} (ID:{{itemData?.recipient_id}})<br>
                <span v-if="itemData?.shipping_address" class="me-2">{{ t('dn.fields.shipping-address') }} :{{itemData?.shipping_address}}</span><br>
                <span v-if="itemData?.recipient?.zip_code">{{ t('common.fields.zip') }} :{{itemData?.recipient?.zip_code}}</span><br>
                <span v-if="itemData?.recipient?.phone">{{ t('common.fields.phone') }} :{{itemData?.recipient?.phone}}</span>
              </p>
            </div>
            ...
            <div class="col-3">
              <p class="tm_mb2"><b class="tm_primary_color">{{t('dn.fields.scheduled-date')}}</b></p>
              <p>{{itemData?.expected_shipping_date}}</p>
            </div>
            <div class="col-3">
              <p class="tm_mb2"><b class="tm_primary_color">{{t('dn.fields.transportation')}}</b></p>
              <p>{{t('dn.transportation.'+itemData?.transportation_mode)}}</p>
            </div>
            
            <div class="col-3" v-if="itemData?.status == 'pending' || itemData?.status == 'in_progress'">
              <p class="tm_mb2"><b class="tm_primary_color">{{t('common.dates.created')}}</b></p>
              <p>{{ $dayjs(itemData?.created_at,'YYYY-MM-DD HH:mm:ss') }}</p>
            </div>
            <div class="col-3" v-if="itemData?.status == 'picked'">
              <p class="tm_mb2"><b class="tm_primary_color">{{t('common.dates.picked')}}</b></p>
              <p>{{ $dayjs(itemData?.picked_at,'YYYY-MM-DD HH:mm:ss') }}</p>
            </div>
            <div class="col-3" v-if="itemData?.status == 'packed'">
              <p class="tm_mb2"><b class="tm_primary_color">{{t('common.dates.packed')}}</b></p>
              <p>{{ $dayjs(itemData?.packed_at,'YYYY-MM-DD HH:mm:ss') }}</p>
            </div>
            <div class="col-3" v-if="itemData?.status == 'delivered'">
              <p class="tm_mb2"><b class="tm_primary_color">{{t('common.dates.delivered')}}</b></p>
              <p>{{ $dayjs(itemData?.delivered_at,'YYYY-MM-DD HH:mm:ss') }}</p>
            </div>
                ...
                <table>
                  <thead>
                    ...
                    <tr>
                      ...
                      <th class="tm_width_1 tm_semi_bold tm_primary_color tm_gray_bg tm_text_right">{{t('common.fields.quantity')}}</th>
                      <th class="tm_width_1 tm_semi_bold tm_primary_color tm_gray_bg tm_text_right">{{t('common.quantities.picked')}}</th>
                      <th class="tm_width_1 tm_semi_bold tm_primary_color tm_gray_bg tm_text_right">{{t('common.quantities.packed')}}</th>
                      <th class="tm_width_1 tm_semi_bold tm_primary_color tm_gray_bg tm_text_right">{{t('common.quantities.delivered')}}</th>
                  ...
                  <tbody>
                    ...
                    <tr v-for="(detail, index) in itemData?.details" >
                      ...
                      <td class="tm_width_1 tm_text_right">{{detail.picked_quantity}}</td>
                      <td class="tm_width_1 tm_text_right">{{detail.packed_quantity}}</td>
                      <td class="tm_width_1 tm_text_right">{{detail.delivered_quantity}}</td>
              ...
              <div class="tm_right_footer">
                <table>
                  <tbody>
                    ...
                    <tr>
                      <td class="tm_width_3 tm_primary_color tm_border_none tm_pt0">{{t('common.quantities.total-picked')}}</td>
                      <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_pt0">{{ itemData?.total_picked_quantity }}</td>
                    </tr>
                    <tr>
                      <td class="tm_width_3 tm_primary_color tm_border_none tm_pt0">{{t('common.quantities.total-packed')}}</td>
                      <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_pt0">{{ itemData?.total_packed_quantity }}</td>
                    </tr>
                    <tr class="tm_border_top tm_border_bottom">
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_primary_color">{{t('common.quantities.total-delivered')}}</td>
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_primary_color tm_text_right">{{ itemData?.total_delivered_quantity }}</td>
                    </tr>
