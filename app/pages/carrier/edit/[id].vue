...
const saveCarrier = async () => {
  ...
  await httpRequest(`/api/warehouse/carrier/${itemId}`, {
    method: 'PUT',
      ...
      <div class="card custom-card">
        <div class="card-body add-products p-0">
                ...
                <div class="card custom-card shadow-none mb-0 border-0">
                  <div class="card-body p-0">
                    <div class="row gy-3 mb-3">
                      <div class="col-xl-6">
                        <label for="carrier-name" class="form-label">{{t('carrier.fields.name')}} <abbr title="required" aria-hidden="true"
                            class="text-danger">*</abbr></label>
                        <input type="text" class="form-control" id="carrier-name" :placeholder="t('common.placeholders.code')"
                      ...
                      <div class="col-xl-6">
                        <label for="carrier-contact" class="form-label">{{t('common.fields.contact')}}</label>
                        <input type="text" class="form-control" id="carrier-contact" :placeholder="t('common.placeholders.contact')"
          ...
          <div class="px-4 py-3 border-top border-block-start-dashed d-sm-flex justify-content-end">
            <button class="btn btn-primary-light m-1" @click="saveCarrier">{{t('carrier.operations.edit')}}<i
